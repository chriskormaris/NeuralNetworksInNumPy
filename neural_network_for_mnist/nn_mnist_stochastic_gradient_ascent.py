...
def train(X, t, W1, W2, epochs=100, tol=1e-6, print_estimate=False, X_val=None, y_val=None):
...
if __name__ == '__main__':
    ...
    W1, W2 = train(X_train, t_train, W1, W2, epochs=100, tol=1e-6, print_estimate=True, X_val=X_test, y_val=y_test_true)
